        ...
        <div className="flex items-center h-full">
          ...
          <div className="max-w-2xl">
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-gray-200 mb-8">
              I am a full-stack developer passionate about creating innovative web solutions
              <span className="text-green-700">Data Analytic</span> , <span className="text-green-700">CyberSecurity</span> and delivering exceptional user experiences.
            </p>
